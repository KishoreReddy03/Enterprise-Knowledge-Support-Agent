...
class JSONLogFormatter(logging.Formatter):
    ...
    Outputs each log line as a single JSON object, compatible with
    CloudWatch, Datadog, ELK, and other log aggregation services.
    """
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        for key in ("request_id", "ticket_id", "customer_id", "agent"):
...
def setup_logging() -> None:
    ...
    - staging/production: Structured JSON format
    """
